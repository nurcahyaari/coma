...
func (r RequestCreateApplication) NewApplication() model.Application {
	uuid := uuid.New()
...
func NewResponseApplication(data model.Application) ResponseApplication {
...
func NewResponseApplications(datas model.Applications) ResponseApplications {
